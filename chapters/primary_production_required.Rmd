...
url2fig <- function(pfx, sfx){
  ...
  url <- glue::glue("{pfx}/{sfx}")
  fig <- here(glue::glue("figures/{sfx}"))
...
knitr::include_graphics("C:/Users/andrew.beet/Documents/MyWork/demo_repos/test-doc/figures/PP-GB.png"     )      

url2fig(imagePath,"PPR-GB-0_80.png")
url2fig(imagePath,"MTL-GB-0_80.png")
url2fig(imagePath,"PP-GB.png")
url2fig(imagePath,"composition-GB-0_80.png")
```
...
url2fig(imagePath,"PPR-GOM-0_80.png")
url2fig(imagePath,"MTL-GOM-0_80.png")
url2fig(imagePath,"PP-GOM.png")
url2fig(imagePath,"composition-GOM-0_80.png")
```

#### Mid-Atlantic Bight (MAB)

```{r, pprmab,  echo=FALSE, out.width='50%'}
url2fig(imagePath,"PPR-MAB-0_80.png")
url2fig(imagePath,"MTL-MAB-0_80.png")
url2fig(imagePath,"PP-MAB.png")
url2fig(imagePath,"composition-MAB-0_80.png")
```
